...
def trigger():
  ...
  def getData():
    ...
    ver = urllib.urlopen('https://cloudburstsys.github.io/place.conep.one/version.txt').read().decode("utf-8").split(".")
    if(ver[0] !== version[0] or ver[1] !== version[1] or ver[2] !== version[2]):
